document.addEventListener('DOMContentLoaded', function() {
    ...
    about.addEventListener('click', function() {
      ...
      imageContainer1.addEventListener('click', function() {
        const section = document.getElementById('women_sec');
        section.scrollIntoView({ behavior: 'smooth' });
      });
    
      imageContainer2.addEventListener('click', function() {
        const section = document.getElementById('men_sec');
        section.scrollIntoView({ behavior: 'smooth' });
      });
    
      imageContainer3.addEventListener('click', function() {
          const section = document.getElementById('luxury_sec');
          section.scrollIntoView({ behavior: 'smooth' });
        });
    
        imageContainer4.addEventListener('click', function() {
          const section = document.getElementById('bodymists_sec');
          section.scrollIntoView({ behavior: 'smooth' });
        });
